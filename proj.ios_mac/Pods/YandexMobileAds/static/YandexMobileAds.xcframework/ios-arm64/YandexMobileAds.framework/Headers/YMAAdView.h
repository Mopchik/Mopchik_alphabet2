...
/**
 ...
 @param adSize The size of the banner. The size of the banner is set in the YMABannerAdSize class.
 @return Initializes an object of the YMAAdView class to display the banner with the specified size.
 */
- (instancetype)initWithAdUnitID:(NSString *)adUnitID adSize:(YMABannerAdSize *)adSize;
