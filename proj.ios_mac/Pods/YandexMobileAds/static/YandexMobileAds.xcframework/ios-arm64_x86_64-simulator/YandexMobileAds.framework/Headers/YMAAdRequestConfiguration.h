...
/**
 Initializes a new object of the YMAAdRequestConfiguration class.
 @param adUnitID The AdUnit ID is a unique identifier in the R-M-XXXXXX-Y format,
 which is assigned in the Partner interface.
 @return An object of the YMAAdRequestConfiguration class, configuration for loading native ads.
 */
